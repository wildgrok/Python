...
def get_emails(username,password,server):
    ...
    pop_conn = poplib.POP3(server)  #use this for outlook server
...
if __name__ == '__main__':
    ...
    # server = 'besada.com';
    username = '_sql_executive@carnival.com';
    password = 'g0dde$$0fl0ve';
    #server = 'smtp.gmail.com:587';
    server = 'CCLOutlook.carnival.com';
    #server = 'smtphost.carnival.com';
    ...
    sentfile = r'D:\JetBrains\PyCharm Community Edition 3.4.1\Toolkit\sentfile.txt'
    ...
    while True:
        ...
        for message in messages:
            ...
            for x in message[1]:
                ...
                if x[0:5].decode() == 'From:':
                    s2 = x[5:].decode()
                    print('From:', s2)

                try:

                    if x[0:8].decode() == 'Subject:':
                        s = x[8:].decode()
                        print('Subject:', s)
                except Exception as inst:
                    #print('Error decoding subject: ', inst)
                    pass
            ...
            if (s2 > '') and (s3 > ''):
                ...
                if s2 in theset:
                    ...
                    print('emails: ', theset)
                    compose_email([s2,'noreply@noreply.com','',''],'PYTHON ROCKS',[['You have graduated from the Python course ... show your pride...\n',0]],'');
