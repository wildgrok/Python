...
if __name__ == '__main__':
    ...
    print('grouped people by gender and group age')
    pprint(map_reduce(persons, lambda p: ((p.gender, p.age//10), p)))    # grouped people by gender and group age
    print('grouped heights')
